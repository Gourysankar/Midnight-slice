...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true)
    try {
      // Role is automatically assigned as 'admin' if email matches ADMIN_EMAIL in backend
    ...
    <div className="page-enter" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '88px 20px' }}>
      <div style={{ width: '100%', maxWidth: 460 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: '#6b7280' }}>Join Midnight Slice and start building</p>
        </div>
        ...
        <div className="glass-card" style={{ padding: '36px 32px' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '14px', fontSize: '1rem', marginTop: 12 }} disabled={loading}>
